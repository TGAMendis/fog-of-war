...
(function() {
	...
	//************
	var _Canvas;
	let _frontImageSrc = 'https://i.ibb.co/GJmYwWm/pointmangrayscale.jpg';
	let _backImageSrc = 'https://i.ibb.co/7QtxPd2/Sri-Lankan-Army-soldiers-patrol-along-the-de-facto-frontline-at-Muhamalai-in-the-Jaffna-Peninsula-so.jpg';
	let _frontImage;
	let _backImage;
	let _blackMask;
	let _mouseX = 0;
	...
	let _delayTime = 0.08;
	let _maskArray = [];
	let _srcArray = ["https://i.ibb.co/4VzNHjY/newstain1.png", "https://i.ibb.co/MPQn7GC/newstain2.png", "https://i.ibb.co/CtSRFSd/newstain3.png"];
